...
void BMSModule::balanceCells()
{
    ...
    float minD = getCellVoltage(0); 
    for(int j = 0 ; j < 6;j++){
      minD = min(minD,getCellVoltage(j));
    }
    memset(balanceState,0,6);
    balance = 0;
                
    for (int i = 0; i < 6 && minD>3.05; i++)
    {

        if ((balanceState[i] == 0) && (getCellVoltage(i) > (minD+0.003)) ) {
             balanceState[i] = 1;
        }
        else{
             balanceState[i] = 0;
    ...
    SERIALCONSOLE.println(minD);
    SERIALCONSOLE.print(balanceState[0]);
    SERIALCONSOLE.print(" ");
        SERIALCONSOLE.print(balanceState[1]);
    SERIALCONSOLE.print(" ");
        SERIALCONSOLE.print(balanceState[2]);
    SERIALCONSOLE.print(" ");
        SERIALCONSOLE.print(balanceState[3]);
    SERIALCONSOLE.print(" ");
        SERIALCONSOLE.print(balanceState[4]);
    SERIALCONSOLE.print(" ");
        SERIALCONSOLE.print(balanceState[5]);
    SERIALCONSOLE.print("\n");
...
void BMSModule::balanceCellsOff()
{
